...
class IndianNewspapersScreenGridView extends StatefulWidget {
  ...
  @override
  State<IndianNewspapersScreenGridView> createState() =>
      _IndianNewspapersScreenGridViewState();
}

class _IndianNewspapersScreenGridViewState
    extends State<IndianNewspapersScreenGridView> {
  @override
  Widget build(BuildContext context) {
    ...
    return GridView.builder(
      ...
      itemCount: indianNewspapersProvider.length,
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => NewsWebView(
                    url: indianNewspapersProvider[index]['newsPaperLink'],
                  ),
                ),
              );
            },
            child: Container(
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage(
                      indianNewspapersProvider[index]['newsPaperImage']),
                ),
                    ...
                    setState(
                        ...
                        if (indianNewspapersProvider[index]['isFavourite']) {
                          favouriteDataProvider
                              .addToFavorite(indianNewspapersProvider[index]);
                        } else {
